...
st.set_page_config(
    page_title="Persona Library Management System",
    page_icon="📚",
    layout="wide",
...
def create_visualizations(stats):
    # Pie chart for read status vs unread status
...
# Footer
st.markdown("---")
st.markdown("© 2025 Haider Asghar Personal Library Manager | Created with Love and Streamlit", unsafe_allow_html=True)            
